...
"""
    ...
    ssh.exec_command('echo Raiz123 | sudo -S docker cp /tmp/create_sensors.py nexgen_scada:/app/create_sensors.py')
    
    stdin, stdout, stderr = ssh.exec_command('echo Raiz123 | sudo -S docker exec nexgen_scada python3 /app/create_sensors.py')
    out = stdout.read()
    err = stderr.read()
